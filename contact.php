...
if (isset($_POST['submit'])) {
	...
	$q="INSERT INTO `tb_msg`(`msg`, `name`, `mail`, `phone`) VALUES ('$msg','$name','$mail','$phone')";
						...
						<div class="row">
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									<li><span><i class="icon-map5"></i></span>Shop. No 1, Poonam Appt, Nandanvanam Main Rd, Nagpur, Maharashtra (440009)</li>
									<li><span><i class="icon-phone4"></i></span>+91 9923183018</li>
									<li><span><i class="icon-phone4"></i></span>+91 8626086940/9370929023</li>
									<li><span><i class="icon-envelope2"></i></span><a href="#">rahul_rr24@rediffmail.com</a></li>
									<li><span><i class="icon-envelope2"></i></span><a href="#">amoldhopte@gmail.com</a></li>
									<li><span><i class="icon-globe3"></i></span><a href="www.chahadotcom.in">www.chahadotcom.in</a></li>
								</ul>
							</div>
						...
						<div class="col-md-3 col-pb-sm">
							...
							<div class="subscribe text-center">
								<div class="form-group">
									...
									<a href="index.php"><input type="submit" value="Subscribe" class="btn btn-primary btn-custom"></a>
								</div>
							</div>
						</div>
					</div>
